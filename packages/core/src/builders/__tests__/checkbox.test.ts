...
describe("BuildCheckbox", () => {
  it("should render trigger and input with correct attributes based on props", () => {
    const { trigger, hiddenInput: input } = BuildCheckbox({
      name: "testCheckbox",
      value: "testValue",
      checked: true,
      required: true,
    ...
    expect(triggerNode.getAttribute("role")).toBe("checkbox");
  ...
  it("should set aria-checked correctly based on checked prop", () => {
    const { trigger: triggerChecked } = BuildCheckbox({
      name: "testCheckbox",
      value: "testValue",
      checked: true,
    });
    ...
    const { trigger: triggerUnchecked } = BuildCheckbox({
      name: "testCheckbox",
      value: "testValue",
      checked: false,
    });
  ...
  it("should set aria-required correctly based on required prop", () => {
    const { trigger: triggerRequired } = BuildCheckbox({
      name: "testCheckbox",
      value: "testValue",
      required: true,
    });
    ...
    const { trigger: triggerNotRequired } = BuildCheckbox({
      name: "testCheckbox",
      value: "testValue",
      required: false,
    });
